...
5. As the requirements of the original project refer to older version which have potential security issues they were removed. Unfortunately, the toolchain needs to be setup from scratch.
